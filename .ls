...
void checked_local_types(void) _Checked{
...
_Tainted _TPtr<int> tainted_sort(int n,  _TArray_ptr<int> ptr, _TPtr<Tstruct twin_turbo> tb){
...
{
	int n = 6;
    _TArray_ptr<int>temp : count(10)= (_TArray_ptr<int>)t_malloc(10*sizeof(int));
    ...
    char buffer[50];
    _TArray_ptr<char> tainted_buffer = (_TArray_ptr<char>)t_malloc(50*sizeof(char));
    int a = 10, b = 20, c;
    c = a + b;
    _TArray_ptr<char> tainted_format = (_TArray_ptr<char>)t_malloc(50*sizeof(char));
    ...
    _TPtr<Tstruct twin_turbo>tb = (_TPtr<Tstruct twin_turbo>)t_malloc(sizeof(Tstruct twin_turbo));
    *tb = tb2;
    tb->engine = (_TArray_ptr<char>)t_malloc(102* sizeof(char));
    _Array_ptr<char> engine_check : count(102) = (_Array_ptr<char>)malloc(102*sizeof(char));
